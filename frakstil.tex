\startxmlsetups xml:teisetups
        \xmlsetsetup{#1}{*}{-} 
        \xmlsetsetup{#1}{TEI|teiHeader|fileDesc|titleStmt|sourceDesc|listObject|objectName|profileDesc|creation|idno|text|body|front|list|item|div|head|p|seg|bibl|ref|note}{xml:*}
